...
import org.assertj.core.api.Assertions; // import Assertions.assertThat -> static써서 자동으로 안쓰게 됨
...
public class MemoryMemberRepositoryTest {
    ...
    public void save() {
        ...
        Member result = repository.findById(member.getId()).get(); // 제대로 들어갔나 검증하기 위해 store(db)에서 저장된 member 꺼내옴. 반환타입이 optional인데, optional 에서 값을 꺼낼 떈 get으로 꺼낼 수 있음
        // System.out.println("result = " + (result == member)); // store에서 꺼내온 result(member)가 member랑 같은지 출력
